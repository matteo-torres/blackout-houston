...
tm_shape(blackout_houston_sf) +
  tm_polygons() +
  tm_layout(title = "Blackout Areas in Houston") +
...
tm_shape(blackout_no_highways) +
  tm_polygons() + 
  tm_layout(title = "Blackout Areas Excluding Highways") +
  tm_graticules(alpha = 0.5) +
  tm_scale_bar(position = c("left", "bottom")) +
  tm_compass(position = c("right", "top"))
```
...
tm_shape(homes_in_blackout) +
  ...
  tm_layout(title = "Homes Likely Impacted by Blackouts") +
  tm_graticules(alpha = 0.5) +
  tm_scale_bar(position = c("left", "bottom")) +
  tm_compass(position = c("right", "top"))
```
...
print(paste("Estimated number of homes in Houston that lost power:", num_homes_affected))
```
...
tm_shape(census_tracts_affected_income) +
  tm_polygons(col = "red") +
  tm_layout(title = "Census Tracts Affected by Blackouts with Median Income") +
  tm_graticules(alpha = 0.5) +
  tm_scale_bar(position = c("left", "bottom")) +
  tm_compass(position = c("right", "top"))
```
